...
const forgotPasswordEmail = (name: string, token: string) => {
  return `
  <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2;">
  <div style="margin:50px auto;width:70%;padding:20px 0">
    <div style="border-bottom:1px solid #FE7A36; ">
    ...
    <p style="font-size:1.1em">Halo,${name}</p>
    <p>Anda meminta untuk melakukan reset password, silahkan tekan tombol dibawah ini untuk melakukan reset password</p>
    <a href="https://bunus.vercel.app/reset-password?token=${token}" style="background: #E55604;margin: 0 auto;width: max-content;padding: 10px 10px;color: #fff;border-radius: 4px;">Tekan Disini</a>
    <p style="font-size:0.9em;">Silahkan abaikan email ini atau beritahu kami jika anda tidak meminta email ini</p>
    <hr style="border:none;border-top:1px solid #FE7A36" />
    <div style="float:right;padding:8px 0;color:#aaa;font-size:0.8em;line-height:1;font-weight:300">
      <p>Bubur Nusantara</p>
...
const homeEmailFormat = (name: string, email: string, message: string) => {
  return `
  <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2;">
  <div style="margin:50px auto;width:70%;padding:20px 0">
    <div style="border-bottom:1px solid #FE7A36; ">
    ...
    <p style="font-size:1.1em">Terdapat Pesan Baru dari Pelanggan,</p>
    <p>Email : ${email}</p>
    <p>Nama : ${name}</p>
    <p>Pesan : ${message}</p>
    <hr style="border:none;border-top:1px solid #FE7A36" />
...
const replyFormat = (name: string) => {
  ...
  <div style="margin:50px auto;width:70%;padding:20px 0">
    ...
    <p style="font-size:1.1em">Halo,${name}</p>
    <p>Terimakasih atas pesan yang anda kirim, kami akan segera membalas pesan dari anda :)</p>
    <p style="font-size:0.9em;">Silahkan abaikan email ini atau beritahu kami jika anda tidak meminta email ini</p>
    <hr style="border:none;border-top:1px solid #FE7A36" />
    <div style="float:right;padding:8px 0;color:#aaa;font-size:0.8em;line-height:1;font-weight:300">
      <p>Bubur Nusantara</p>
...
export { formatEmail, forgotPasswordEmail, homeEmailFormat, replyFormat };
